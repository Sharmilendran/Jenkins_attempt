...
//
//
//        public static List<Students> ListS=new ArrayList<Students>();
...
//
//
//        public double  MinAssign(Double Assign1,Double Assign2){
...
//        }
//
//        public double  Project(Double Design,Double Implementaion){
//            this.Design=Design;
...
//        }
//
//        public double  FinalExam(Double Exam){
//            this.ExamF=(Exam*(0.5));
//            return ExamF;
//
//        }
//
//        public double FinalGrade(double ExamF,double project,double MinAssign){
...
//            if((ExamF*1.5> 50.0) && (project+MinAssign>=35)&& (modMark>=50)){
//
...
//
//
//        public static void Average(List<Students> array){
...
//
//        }
//        public static void HighestScorer(List<Students> Students){
...
//
//
//        public static void SupplementE(List<Students> supplementE){
...
//        }
//
//        public static void Retake(List<Students> retake) {
...
//
//
//        public static List  StudentLister(List<Students> Student){
